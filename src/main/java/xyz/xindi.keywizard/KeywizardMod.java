...
@Mod(KeywizardMod.MODID)
public class KeywizardMod
{
    ...
    public KeywizardMod(IEventBus modEventBus, ModContainer modContainer)
    {
        ...
        // Note that this is necessary if and only if we want *this* class (KeywizardMod) to respond directly to events.
