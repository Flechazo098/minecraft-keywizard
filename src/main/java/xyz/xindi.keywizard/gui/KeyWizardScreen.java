...
import xyz.xindi.keywizard.KeywizardMod;
...
public class KeyWizardScreen extends OptionsSubScreen {
    ...
    public KeyWizardScreen(Screen parent) {
        super(parent, Minecraft.getInstance().options, Component.nullToEmpty(KeywizardMod.MODID));
    }
    ...
    protected void init() {
        ...
        this.screenToggleButton = new ImageButton(this.width - 22, this.height - 22, 20, 20, new WidgetSprites(KeywizardMod.SCREEN_TOGGLE_WIDGETS, KeywizardMod.SCREEN_TOGGLE_WIDGETS), btn -> {
